...
namespace BackstageTemplates {
      ...
      children: (
        <form class="backstage-modal-form" novalidate onSubmit={submit}>
          ...
          <div class="backstage-modal-actions">
            <button
              type="button"
              class="backstage-modal-button"
              onClick={props.onCancel}
            >
              {_('Cancel')}
            </button>
            <button type="submit" class="backstage-modal-button is-primary">
  ...
  function dangerSection(onDelete: () => void): HTMLElement {
    return (
      <div class="backstage-modal-danger-section">
        ...
        <button
          type="button"
          class="backstage-modal-danger-button"
          onClick={onDelete}
        >
          {_('Delete')}
        </button>
      ...
      children: (
        <>
          ...
          <div class="backstage-modal-actions">
            ...
            <button
              type="button"
              class="backstage-modal-button is-primary"
      ...
      children: (
        <>
          ...
          <div class="backstage-modal-actions">
            ...
            <button
              type="button"
              class="backstage-modal-button is-danger"
  ...
  export function kindDropdown(
    ...
    const kinds: { value: CloudProviderKind; label: string }[] = [
      ...
      { value: 'hyperdrive', label: _('Hyperdrive') },
